...
#define HBHO_OPT_TYPE_MPL          0x0C       //0x6D
...
#define MPL_DATA_MESSAGE_IMAX               MPL_DATA_MESSAGE_IMIN
#else
...
#define MPL_SEED_ID_TYPE                    0 //MPL_SEED_ID will be th IPv6 address
#else
...
#endif
/*
 * 1 - Indicates that reactive forwarding be enabled
 * 0 - Indicates that reactive forwarding be disabled
 */
#ifndef MPL_CONF_REACTIVE_FORWARDING
#define MPL_REACTIVE_FORWARDING            0
#else
...
#define MPL_DATA_MESSAGE_TIMER_EXPIRATIONS  2
#else
